...
Odot costs more than 700,000,000 tokens in codex, the foundational framework of oDot is built upon codex, while GPT-5.6 Sol enhances oDot with more complex functionalities, optimizes the existing frontend styles/UI layouts, and resolves numerous known bugs. It can be said that over 95% of the project's code was generated by AI.
